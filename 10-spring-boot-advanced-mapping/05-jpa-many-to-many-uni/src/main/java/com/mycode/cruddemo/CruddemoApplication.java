...
import com.mycode.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO)
	{
		return runner -> {
			...
			//retrieveCourseAndStudentByCourseId(appDAO);
			//retrieveStudentAndCourseByStudentId(appDAO);
	...
	private void retrieveStudentAndCourseByStudentId(AppDAO appDAO) {
		int theId = 2;
		Student tempStudent = appDAO.findStudentAndCoursesByStudentId(theId);
	...
	private void retrieveCourseAndStudentByCourseId(AppDAO appDAO) {
		int theId = 10;
	...
	private void createCourseAndStudent(AppDAO appDAO) {
		// create a course
		Course course = new Course("Piano Class");

		// create the students
		Student student1 = new Student("Moe","Nandi", "moenandi10@gmail.com");
		Student student2 = new Student("Myint Aung","Zaw", "alienjj1177@gmail.com");
